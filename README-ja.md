...
このプラグインは、新規サイトや、まだ permalink 方針を固めている途中のサイト、あるいは slug 運用が不要な構造化コンテンツ向けのケースに向いています。

すでに大量の記事を公開していて slug ベースの URL を広く運用しているサイトでは、導入前に影響をよく確認してください。既存の被リンク、検索流入、SNS シェア、編集フローへの影響を見ておくのが安全です。
